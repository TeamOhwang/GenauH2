...
export default function Sidebar() {
    ...
    const userMenu = [
        ...
        { label: "상세 데이터 일간 조회", to: PATHS.facilityPage, icon: <ChartLine /> },
        { label: "상세 데이터 기간 조회", to: PATHS.equipmentList, icon: <ChartLine /> },
        { label: "설비 모니터링", to: PATHS.test, icon: <TestTube /> },
