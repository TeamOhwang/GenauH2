    ...
    return (
        <aside className="w-64 bg-white shadow-md p-4 h-full">
            <nav className="space-y-3">
                ...
                <NavLink className="block text-gray-700 hover:text-blue-500" to={PATHS.hourly}>시간별 모니터링</NavLink>
                <NavLink className="block text-gray-700 hover:text-blue-500" to={PATHS.daily}>데일리 모니터링</NavLink>
                <NavLink className="block text-gray-700 hover:text-blue-500" to={PATHS.weekly}>주간 모니터링</NavLink>
                <NavLink className="block text-gray-700 hover:text-blue-500" to={PATHS.monthly}>월간 모니터링</NavLink>
