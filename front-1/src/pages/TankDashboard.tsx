...
export default function TankDashboard() {
  ...
  return (
    <div className="p-10 bg-white dark:bg-slate-900 min-h-screen text-black dark:text-white transition-colors duration-300">
      {/* 상단 타이틀 */}
      <h1 className="text-5xl font-extrabold mb-10 bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent tracking-wide">
        GenauH2
      </h1>
      ...
      <div className="grid grid-cols-2 gap-10">
        ...
        <div className="flex flex-col gap-6">
          {/* 수소탱크 카드 */}
          <div className="bg-gray-100 dark:bg-slate-800/40 rounded-2xl p-6 shadow-lg backdrop-blur-md flex justify-center">
            <HydrogenTank totalProduction={totalProduction} />
          </div>

          {/* 월별 그래프 카드 */}
          <div className="bg-gray-100 dark:bg-slate-800/40 rounded-2xl p-6 shadow-lg backdrop-blur-md">
